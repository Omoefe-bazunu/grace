...
//   // Tracks the player's native status (idle / loading / readyToPlay / error)
//   // so we can show a spinner during the buffering gap that follows the
//   // metadata fetch — this is the part that feels "frozen" on slower devices.
...
//   // Optional: ask the player to start with a smaller forward buffer so
//   // playback can begin sooner, at the cost of slightly more rebuffering
//   // risk later on a poor connection. Wrapped in try/catch since older
//   // expo-video versions may not expose this — safe to skip if unsupported.
//   useEffect(() => {
//     if (!player) return;
//     try {
...
//       };
//     } catch (e) {
//       // Not supported on this expo-video version — no-op.
//     }
//   }, [player]);
