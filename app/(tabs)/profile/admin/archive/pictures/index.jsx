...
export default function UploadPictures() {
  ...
  const handleUploadAll = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Archive updated!');
      setFiles([]);
      setTitle('');
      setDesc('');
    } catch (e) {
      Alert.alert('Error', 'Failed to save to Archive database.');
    } finally {
  ...
  return (
    <SafeAreaWrapper>
      <TopNavigation showBackButton={true} title="Upload Archive" />
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.inputGroup}>
          ...
          <TextInput
            ...
            placeholder="e.g. Annual Convention"
            style={styles.input}
